...
sudo /usr/bin/sed -i '' 's/#ChallengeResponseAuthentication.*/ChallengeResponseAuthentication no/g' /etc/ssh/sshd_config
sudo /usr/bin/sed -i '' 's/^ChallengeResponseAuthentication.*/ChallengeResponseAuthentication no/g' /etc/ssh/sshd_config

# disable PasswordAuth
sudo /usr/bin/sed -i '' 's/#PasswordAuthentication.*/PasswordAuthentication no/g' /etc/ssh/sshd_config
sudo /usr/bin/sed -i '' 's/^PasswordAuthentication.*/PasswordAuthentication no/g' /etc/ssh/sshd_config
